...
export default function SentenceBuilder({
  ...
  // Removed showConfetti and voices as per request and cleanup
  ...
  const speak = async (text: string) => {
    // Ensure we are in the browser/client environment
    if (typeof window === "undefined") return;

    try {
      // Dynamic import to avoid SSR issues with some Capacitor plugins
